            ...
            <div className="flex flex-col w-full overflow-y-auto p-6 gap-6">
                <div className="flex  w-full gap-6">
                    ...
                    <div className="w-full lg:w-3/4  rounded-lg  p-4">
                        <h2 className="text-xl font-bold bg-white rounded-lg shadow-lg p-4 text-[#14509F] mb-4">Calendar</h2>
                    ...
                    <div className="w-full lg:w-1/3 bg-white rounded-lg shadow-lg p-6">
                        ...
                        <div className="bg-gradient-to-r from-black to-gray-800 text-white p-4 rounded mb-6 flex justify-between items-center">
