...
import SrDevApplyForLeaveModal from "./srDevApplyForLeaveModal";
import SrDevApplyForWFHModal from "./srDevApplyForWFHModal";
...
const CalendarPage = () => {
    ...
    return (
        <div className="flex min-h-screen bg-[#ECECEC] font-jakarta">
            ...
            {/* Modals */}
            <SrDevApplyForLeaveModal isOpen={isLeaveModalOpen} onClose={() => setIsLeaveModalOpen(false)} />
            <SrDevApplyForWFHModal isOpen={isWFHModalOpen} onClose={() => setIsWFHModalOpen(false)} />
        </div>
    );
};
