...
const SrDevApplyForLeaveModal = ({ isOpen, onClose }) => {
      ...
      <div className="bg-[#F6F6F6] rounded-lg shadow-lg p-6 w-96">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex w-full">
            <button
              type="submit"
              className="w-full bg-[#1D49A7] text-white py-2 px-4 rounded hover:bg-blue-600"
            >
              Apply
            </button>
          </div>
...
export default SrDevApplyForLeaveModal;
