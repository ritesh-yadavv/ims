...
const UpcomingAgenda = () => {
  return (
    <>
      <table className=" sm:mt-5 md:mt-0 sm:ml-2 md:ml-5  sm:w-[280px] xl:pl-3 sm:pr-4 xl:w-[300px] md:w-6/20  divide-gray-200 inline-block  justify-center align-center border-2 border-grey-700 content-align  mx-auto rounded-lg">
        <thead>
          <tr>
            <th className="py-1 mb-10 pt-4 my-4 md:text-[16px] xl:text-[20px] pb-4">
              Upcoming Agendas
            </th>
          </tr>
        </thead>
