...
const AccountAccess = () => {
  ...
  return (
    <div className="p-6 bg-white mx-auto w-full font-jakarta rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200 md:col-span-2">
            <span className="text-gray-700">Last Login</span>
            <span className="text-gray-900 font-medium">{formatDateTime(Employee.lastLogin)}</span>
          </div>
        </div>
      </div>
